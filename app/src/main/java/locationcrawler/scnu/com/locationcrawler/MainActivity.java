        ...
        public void handleMessage(Message msg) {
            switch(msg.what) {
                ...
                case Constant.REQUEST_OK:
                    Toast.makeText(MainActivity.this,"爬取周边美食信息成功，结果已经存入"+msg.obj.toString(),Toast.LENGTH_SHORT).show();
                    break;
                case Constant.REQUEST_FAIL:
                    Toast.makeText(MainActivity.this,"爬取周边美食信息失败",Toast.LENGTH_SHORT).show();
                    break;
                default:
                    break;
            }
...
////        setSupportActionBar(toolbar);
        ...
        crawlButton = (Button) findViewById(R.id.button);
        crawlButton.setOnClickListener(this);
        ...
        aMap.setOnMyLocationChangeListener(new AMap.OnMyLocationChangeListener() {
            ...
            public void onMyLocationChange(Location location) {
                ...
                String s1 = "latitude:"+String.valueOf(location.getLatitude())+"\n";
                String s2 = "longtitude:"+String.valueOf(location.getAltitude());
                Log.e("location",s1+s2);

                Message msg = new Message();
                msg.what = Constant.LOCATION;
                msg.obj = "Latitude: "+latitude+"\nLongitude: "+longitude;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.button:
                Toast.makeText(MainActivity.this,"开始爬取周边美食信息",Toast.LENGTH_SHORT).show();
                CrwalerThread crwalerThread = new CrwalerThread(latitude,longitude,mHandler);
                crwalerThread.start();
                break;
            default:
                break;
    ...
    public void onLocationChanged(AMapLocation amapLocation) {
        ...
        if (amapLocation != null) {
            if (amapLocation.getErrorCode() == 0) {
                ...
                Log.e("location", "onMyLocationChange: "+longitude);
